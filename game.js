...
// Waves
  ...
  // Touch controls (mobile): mirror mouse logic
  ...
  function handleTouch(e){
    // allow touch in non-keyboard modes (mouse/touch)
    if (controlMode && controlMode.value === 'keyboard') return;
